...
typedef NS_ENUM(NSUInteger, SVProgressHUDLayoutStyle) {
    SVProgressHUDLayoutStyleDefault = 1,  // default layout style is SVProgressHUD style
    SVProgressHUDLayoutStylePCN           // customme layout style of pcn
};
...
@property(assign, nonatomic) SVProgressHUDLayoutStyle defaultLayoutStyle UI_APPEARANCE_SELECTOR; // default is SVProgressHUDLayoutStylePCN
...
+ (void)setDefaultLayoutStyle:(SVProgressHUDLayoutStyle)layoutStyle;// default is SVProgressHUDLayoutStyleDefault
...
/// @param imageArray image in apng file
/// @param imageDuration image animation duration
/// @param repeatTimes image animation repeat count
/// @param status hud message
/// @param dismissDuration hud dismiss duration default 0 is infinite, example 1 is 1second


/// show animation image
/// @param lightImages light images
/// @param darkImages dark images
/// @param imageDuration image duration
/// @param repeatTimes repeatTimes
/// @param status hud message
/// @param dismissDuration hud dismiss duration default 0 is infinite, example 1 is 1second
+(void)showAnimationLightImages:(nonnull NSArray<UIImage*>*)lightImages darkImages:(nullable NSArray<UIImage*>*)darkImages imageDuration:(NSTimeInterval)imageDuration repeatTimes:(NSUInteger)repeatTimes status:(nonnull NSString*)status dismissDuration:(NSTimeInterval)dismissDuration;
