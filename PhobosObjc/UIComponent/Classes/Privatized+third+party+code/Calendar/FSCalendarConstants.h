...
#define FSCalendarStandardSelectionColorLight   FSColorRGBA(31,119,219,1.0)
#define FSCalendarStandardTodayColorLight       FSColorRGBA(198,51,42,1.0)
#define FSCalendarStandardTitleTextColorLight   FSColorRGBA(14,69,221,1.0)
#define FSCalendarStandardEventDotColorLight    FSColorRGBA(31,119,219,0.75)

#define FSCalendarStandardSelectionColorDark   FSColorRGBA(31,119,219,1.0)
#define FSCalendarStandardTodayColorDark       FSColorRGBA(198,51,42,1.0)
#define FSCalendarStandardTitleTextColorDark   FSColorRGBA(255,59,48,1.0)
#define FSCalendarStandardEventDotColorDark    FSColorRGBA(31,119,219,0.75)
...
@interface FSCalendarConstants : NSObject
