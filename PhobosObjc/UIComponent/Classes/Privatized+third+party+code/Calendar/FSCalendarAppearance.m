...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _headerTitleColor = FSCalendarConstants.standardTitleTextColor;
        _headerDateFormat = @"MMMM yyyy";
        _headerMinimumDissolvedAlpha = 0.2;
        _weekdayTextColor = FSCalendarConstants.standardTitleTextColor;
        ...
        _backgroundColors[@(FSCalendarCellStateSelected)]    = FSCalendarConstants.standardSelectionColor;
        ...
        _backgroundColors[@(FSCalendarCellStateToday)]       = FSCalendarConstants.standardTodayColor;
        ...
        _borderRadius = 1.0;
        _eventDefaultColor = FSCalendarConstants.standardEventDotColor;
        _eventSelectionColor = FSCalendarConstants.standardEventDotColor;
